...
import { EntityResultModel, Result, UserRole } from '../../Models/EntityResultModel';
...
export class AccountService {
    ...
    register(user: RegisterModel) {
        ...
        return this.http.post<EntityResultModel>(this.apiUrl + '/account/register', body).pipe(catchError(this.handleError));
    }
    ...
    addContactMessage(nameSurname: any, phone: any, email: any, message: any) {
        ...
        return this.http.post<EntityResultModel>(this.apiUrl + '/account/addContactMessage', formData).pipe(catchError(this.handleError));
    }
    ...
    forgotPassword(email: any) {
        ...
        return this.http.post<EntityResultModel>(this.apiUrl + '/account/forgotPassword', body).pipe(catchError(this.handleError));
    }
    ...
    resetPassword(email: any, code: any, password: any) {
        ...
        return this.http.post<EntityResultModel>(this.apiUrl + '/account/resetPassword', body).pipe(catchError(this.handleError));
    }
